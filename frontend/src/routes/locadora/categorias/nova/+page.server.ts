...
export const actions: Actions = {
  criar: async ({ request, locals, cookies }) => {
    ...
    try {
      ...
      return fail(400, { erros: {}, erro: e?.message ?? 'Erro ao cadastrar categoria.', campos });
    }

    setFlash(cookies, { tipo: 'sucesso', mensagem: `Categoria "${groupName}" cadastrada com sucesso.` });
